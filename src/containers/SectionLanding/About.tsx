...
const authors = [
  ...
  },
  {
    ...
    position: "Thành viên",
    profile:
      "https://www.facebook.com/profile.php?id=100020801284969&mibextid=LQQJ4d",
  },
  {
    name: "Nguyễn Kim Vui",
  ...
  return (
    <section id="about" className="border-b border-gray-300 py-16">
      <div className="text-center flex flex-col items-center gap-6">
        ...
        <p>
          Nhóm đã xây dựng một website nhằm giúp cho việc ghi chú trở nên dễ
          dàng hơn. <br />
          Cảm ơn bạn đã ủng hộ, nhóm rất hy vọng có ích cho bạn trong công việc
          !
        </p>
        <div className="flex gap-8 mx-auto mt-10 flex-wrap justify-center mb-8">
          {authors.map((e) => {
            return (
              ...
              >
                <img
                  className="w-[100px] h-[100px] rounded-full border-4 shadow-md shadow-gray-400 overflow-hidden hover:opacity-75"
                  src={e.avatar}
                  alt={e.name}
                />
        ...
        <Link
          to="/contact-us"
          className="inline-flex items-center px-4 py-2 w-fit border border-transparent text-sm font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
        >
          Cần hỗ trợ
        </Link>
      </div>
